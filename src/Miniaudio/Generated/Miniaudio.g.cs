// <auto-generated>
// Generated by ClangSharpPInvokeGenerator directly from external/miniaudio/miniaudio.h.
// Run eng/generate-bindings.ps1 or eng/generate-bindings.sh after updating the submodule.
// </auto-generated>
...
public partial struct ma_device_info
{
    ...
    [NativeTypeName("struct (anonymous struct at external/miniaudio/miniaudio.h:7093:5)[64]")]
...
public static unsafe partial class MA
{
    ...
    {
        return (float*)(ma_offset_pcm_frames_ptr((void*)(p), offsetInFrames, (ma_format)(ma_format.ma_format_f32), channels));
    }
    ...
    {
        return (float*)(ma_offset_pcm_frames_const_ptr((void*)(p), offsetInFrames, (ma_format)(ma_format.ma_format_f32), channels));
    }
    ...
    [NativeTypeName("#define MA_VERSION_MAJOR 0")]
    public const int MA_VERSION_MAJOR = 0;

    [NativeTypeName("#define MA_VERSION_MINOR 11")]
    public const int MA_VERSION_MINOR = 11;

    [NativeTypeName("#define MA_VERSION_REVISION 25")]
    public const int MA_VERSION_REVISION = 25;

    [NativeTypeName("#define MA_VERSION_STRING MA_XSTRINGIFY(MA_VERSION_MAJOR) \".\" MA_XSTRINGIFY(MA_VERSION_MINOR) \".\" MA_XSTRINGIFY(MA_VERSION_REVISION)")]
    public static ReadOnlySpan<byte> MA_VERSION_STRING => "0.11.25"u8;

    [NativeTypeName("#define MA_SIZEOF_PTR 8")]
    public const int MA_SIZEOF_PTR = 8;

    [NativeTypeName("#define MA_TRUE 1")]
    public const int MA_TRUE = 1;

    [NativeTypeName("#define MA_FALSE 0")]
    public const int MA_FALSE = 0;

    [NativeTypeName("#define MA_SIZE_MAX 0xFFFFFFFF")]
    public const uint MA_SIZE_MAX = 0xFFFFFFFF;

    [NativeTypeName("#define MA_UINT64_MAX (((ma_uint64)0xFFFFFFFF << 32) | (ma_uint64)0xFFFFFFFF)")]
    public const ulong MA_UINT64_MAX = (((ulong)(0xFFFFFFFF) << 32) | (ulong)(0xFFFFFFFF));

    [NativeTypeName("#define MA_SIMD_ALIGNMENT 32")]
    public const int MA_SIMD_ALIGNMENT = 32;

    [NativeTypeName("#define MA_MIN_CHANNELS 1")]
    public const int MA_MIN_CHANNELS = 1;

    [NativeTypeName("#define MA_MAX_CHANNELS 254")]
    public const int MA_MAX_CHANNELS = 254;

    [NativeTypeName("#define MA_MAX_FILTER_ORDER 8")]
    public const int MA_MAX_FILTER_ORDER = 8;

    [NativeTypeName("#define MA_MAX_LOG_CALLBACKS 4")]
    public const int MA_MAX_LOG_CALLBACKS = 4;

    [NativeTypeName("#define MA_CHANNEL_INDEX_NULL 255")]
    public const int MA_CHANNEL_INDEX_NULL = 255;

    [NativeTypeName("#define MA_DATA_SOURCE_SELF_MANAGED_RANGE_AND_LOOP_POINT 0x00000001")]
    public const int MA_DATA_SOURCE_SELF_MANAGED_RANGE_AND_LOOP_POINT = 0x00000001;

    [NativeTypeName("#define MA_DATA_FORMAT_FLAG_EXCLUSIVE_MODE (1U << 1)")]
    public const uint MA_DATA_FORMAT_FLAG_EXCLUSIVE_MODE = (1U << 1);

    [NativeTypeName("#define MA_MAX_DEVICE_NAME_LENGTH 255")]
    public const int MA_MAX_DEVICE_NAME_LENGTH = 255;

    [NativeTypeName("#define ma_resource_manager_job_init ma_job_init")]
    public static readonly delegate*<ushort, ma_job> ma_resource_manager_job_init = &ma_job_init;

    [NativeTypeName("#define ma_resource_manager_job_queue_config_init ma_job_queue_config_init")]
    public static readonly delegate*<uint, uint, ma_job_queue_config> ma_resource_manager_job_queue_config_init = &ma_job_queue_config_init;

    [NativeTypeName("#define ma_resource_manager_job_queue_get_heap_size ma_job_queue_get_heap_size")]
    public static readonly delegate*<ma_job_queue_config*, nuint*, ma_result> ma_resource_manager_job_queue_get_heap_size = &ma_job_queue_get_heap_size;

    [NativeTypeName("#define ma_resource_manager_job_queue_init_preallocated ma_job_queue_init_preallocated")]
    public static readonly delegate*<ma_job_queue_config*, void*, ma_job_queue*, ma_result> ma_resource_manager_job_queue_init_preallocated = &ma_job_queue_init_preallocated;

    [NativeTypeName("#define ma_resource_manager_job_queue_init ma_job_queue_init")]
    public static readonly delegate*<ma_job_queue_config*, ma_allocation_callbacks*, ma_job_queue*, ma_result> ma_resource_manager_job_queue_init = &ma_job_queue_init;

    [NativeTypeName("#define ma_resource_manager_job_queue_uninit ma_job_queue_uninit")]
    public static readonly delegate*<ma_job_queue*, ma_allocation_callbacks*, void> ma_resource_manager_job_queue_uninit = &ma_job_queue_uninit;

    [NativeTypeName("#define ma_resource_manager_job_queue_post ma_job_queue_post")]
    public static readonly delegate*<ma_job_queue*, ma_job*, ma_result> ma_resource_manager_job_queue_post = &ma_job_queue_post;

    [NativeTypeName("#define ma_resource_manager_job_queue_next ma_job_queue_next")]
    public static readonly delegate*<ma_job_queue*, ma_job*, ma_result> ma_resource_manager_job_queue_next = &ma_job_queue_next;

    [NativeTypeName("#define MA_RESOURCE_MANAGER_MAX_JOB_THREAD_COUNT 64")]
    public const int MA_RESOURCE_MANAGER_MAX_JOB_THREAD_COUNT = 64;

    [NativeTypeName("#define MA_MAX_NODE_BUS_COUNT 254")]
    public const int MA_MAX_NODE_BUS_COUNT = 254;

    [NativeTypeName("#define MA_MAX_NODE_LOCAL_BUS_COUNT 2")]
    public const int MA_MAX_NODE_LOCAL_BUS_COUNT = 2;

    [NativeTypeName("#define MA_NODE_BUS_COUNT_UNKNOWN 255")]
    public const int MA_NODE_BUS_COUNT_UNKNOWN = 255;

    [NativeTypeName("#define MA_ENGINE_MAX_LISTENERS 4")]
    public const int MA_ENGINE_MAX_LISTENERS = 4;

    [NativeTypeName("#define MA_LISTENER_INDEX_CLOSEST ((ma_uint8)-1)")]
    public const byte MA_LISTENER_INDEX_CLOSEST = unchecked((byte)(-1));

    [NativeTypeName("#define MA_SOUND_SOURCE_CHANNEL_COUNT 0xFFFFFFFF")]
